                    ...
                    <div class="lg:mb-0 mb-10">
                        <div class="group w-full h-full">
                            <div class="relative h-full">
                                <img src="/onyx-medical-center/public/img/kinplazafrontview2.jpg" alt="Nous contacter" class="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-yellow-700" />
