...
if (!$auth->isAuthenticated()) {
    header('Location: /onyx-medical-center/public/admin/login.php');
    exit();
}
...
if ($user['name'] !== 'super-admin' && $user['name'] !== 'admin') {
    header(header: 'Location: /onyx-medical-center/public/admin/404.php');
    exit();
}
...
<body>
                ...
                <div
                        ...
                        <nav class="flex" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                <li class="inline-flex items-center">
                                    <a href="/onyx-medical-center/public/admin" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="/onyx-medical-center/public/admin/plats" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Plats</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div>
                        <div class="inline-flex gap-x-2">
                            ...
                            <a href="/onyx-medical-center/public/admin/plats/create.php"
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-neutral-400">
                            Ajoutez des repas et supprimez ceux qui ne sont plus proposés par l'hôtel.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <?php if (!empty($plats)) : ?>
                            ...
                            foreach ($plats as $plat) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="hover:text-gray-600 hover:underline hover:cursor-pointer" href="/onyx-medical-center/public/admin/categories/detail.php?id=<?= $plat['categorie_id'] ?>">
                                            <?= $plat['categorie'] ?>
                                        </a>
                                    </td>
                                    <td>
                                        <a class="hover:text-gray-600 hover:underline hover:cursor-pointer" href="/onyx-medical-center/public/admin/menus/detail.php?id=<?= $plat['menu_id'] ?>">
                                            <?= $plat['menu'] ?>
                                        </a>
                                    </td>
                                    ...
                                    <td class="flex items-center justify-center space-x-1">
                                        ...
                                        <a href="/onyx-medical-center/public/admin/plats/post-remove?id=<?= $plat['id'] ?>" onclick="removeplat(event)" data-modal-toggle="modal-remove-plat" data-modal-target="modal-remove-plat">
    ...
    <script src="/onyx-medical-center/node_modules/flowbite/dist/flowbite.min.js"></script>
