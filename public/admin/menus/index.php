                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="/onyx-medical-center/public/admin/menus" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Menus</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                            ...
                            <?php foreach ($menus as $menu) : ?>
                                <tr>
                                    ...
                                    <td class="flex items-center justify-center space-x-1">
                                        ...
                                        <a href="/onyx-medical-center/public/admin/menus/post-remove.php?id=<?= $menu['id'] ?>" onclick="removemenu(event)" data-modal-toggle="modal-remove-menu" data-modal-target="modal-remove-menu">
