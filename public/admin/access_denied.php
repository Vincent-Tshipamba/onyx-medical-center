    ...
    <div class="mx-auto h-screen w-screen bg-gray-50 flex justify-center items-center">
        <div class="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700">
            <div class="w-full lg:w-1/2 mx-8">
                ...
                <a href="/onyx-medical-center/public" class="px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-yellow-600 active:bg-green-600 hover:bg-yellow-700">Retourner à la page d'accueil</a>
            </div>
