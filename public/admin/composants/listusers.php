            ...
            <?php if (!empty($users)) : ?>
                ...
                foreach ($users as $user) : ?>
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <a href="/onyx-medical-center/public/admin/users/post-remove.php?id=<?= $user['id'] ?>" onclick="remove(event)" data-modal-target="remove-user-modal" data-modal-toggle="remove-user-modal" class="hover:text-white">
