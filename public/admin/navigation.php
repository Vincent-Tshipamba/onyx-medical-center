        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="/onyx-medical-center/public/admin" class="flex ms-2 md:me-24">
                        <span
                    ...
                    <div class="flex items-center ms-3">
                        ...
                        <div>
                            <button type="button"
                                ...
                                <span class="sr-only"></span>
                                <img class="w-8 h-8 rounded-full" src="/onyx-medical-center/public/img/profil.jpeg" alt="user photo">

                            </button>
                        </div>
                        <div class="">
                            <a href="/onyx-medical-center/public" class="text-yellow-500 space-x-2 font-bold">
    ...
    <aside id="logo-sidebar"
        ...
        <div style="padding-top: 85px;" class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="/onyx-medical-center/public/admin"
                        ...
                        <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
                            <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                                <p
                                    ...
                                    <a href="/onyx-medical-center/public/admin/menus">Liste des menus</a>
                                </p>
                                <p
                                    class="mb-2 p-2 hover:bg-gray-100 rounded-lg text-gray-900 hover:text-gray dark:text-gray-400 ">
                                    <a href="/onyx-medical-center/public/admin/categories">Liste des catégories</a>
                                </p>
                                <p
                                    class="mb-2 p-2 hover:bg-gray-100 rounded-lg text-gray-900 hover:text-gray dark:text-gray-400">
                                    <a href="/onyx-medical-center/public/admin/plats">Liste des plats</a>
                                </p>
                ...
                <?php if ($user['role'] == 'super-admin') { ?>
                    <li>
                        <a href="/onyx-medical-center/public/admin/users"
                            class="flex items-center space-x-3 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ">
                ...
                <?php } ?>
                <li>
                    <a href="/onyx-medical-center/public/admin/commandes"
                        class="flex items-center space-x-3 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M8 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 9a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a4 4 0 0 0-4-4H6Zm7.25-2.095c.478-.86.75-1.85.75-2.905a5.973 5.973 0 0 0-.75-2.906 4 4 0 1 1 0 5.811ZM15.466 20c.34-.588.535-1.271.535-2v-1a5.978 5.978 0 0 0-1.528-4H18a4 4 0 0 1 4 4v1a2 2 0 0 1-2 2h-4.535Z" clip-rule="evenodd" />
                        </svg>
