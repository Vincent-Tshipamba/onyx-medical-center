                            ...
                            foreach ($categories as $key => $categorie) : ?>
                                <tr>
                                    ...
                                    <td class="flex items-center justify-center space-x-1">
                                        ...
                                        <a href="/onyx-medical-center/public/admin/categories/post-remove.php?id=<?= $categorie['id'] ?>" onclick="removecategorie(event)" data-modal-toggle="modal-remove-categorie" data-modal-target="modal-remove-categorie">
