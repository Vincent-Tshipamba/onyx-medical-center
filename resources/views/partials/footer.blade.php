    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Avenue des Huileries 171 (Croisement Aketi-Huilerie, en face de la station Ariana), Lingwala, Kinshasa</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+243 815 435 661</p>
